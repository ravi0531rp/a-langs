...
# To run the server ; uvicorn main_v2:app --port 8000 --reload
...
import inflect
from utils import BaseValueMapping, ModelWeights, timer
from schemas import Address, Model
...
async def add_address(address : Address, db : Session = Depends(get_db)):
    logger.info(address)
